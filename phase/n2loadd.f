...
c
c        Charge-Dependent Chiral NN Potential at Order Three
c        --------------------------------------------------
c        applying a cutoff of 500 MeV: N2LO(500).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n2lo500' needs to be called by the user.
...
19002 format (////' error in n2lo: total angular momentum j',
...
c
      ...
      label=nucnuc(inter)
c
c      go to (21,22,23), inter
c   21 write (kwrite,10001) 
10001 format (' The pp potential is used.')
c      go to 24
c   22 write (kwrite,10002) 
10002 format (' The np potential is used.')
c      go to 24
c   23 write (kwrite,10003) 
10003 format (' The nn potential is used.')
c   24 write (kwrite,10004) 
10004 format (' -------------------------'//)
c
c
      iftgo=ift(inter)+1
...
c
 ...
 8405 v(iv)=v(iv)+vv0(iv)+vv2(iv)+vv4(iv)
      call lsjdecomposition(pot,j)
      do 8406 iv=1,6
 8406 v(iv)=v(iv)+pot(iv)
c
      end if
c
c
...
c
c
      data ((tab(i,j),i=1,5),j=1,61)/
     1    6.000000000d0,   0.0d0,    4.0000d0,  600.0d0,   0.0d0,
     ...
     *    6.000000000d0,   0.0d0,    2.0000d0,  600.0d0,   0.0d0,
     1    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     2   13.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     4   14.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5   -1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     6   11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   14.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     9   57.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     1   59.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2   -1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     3   11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4   59.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   0.0d0,    2.0000d0,  700.0d0,   0.0d0,
     6    0.000000000d0,   3.0d0,  700.0000d0,    0.0d0,   0.0d0,
     7    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   3.0d0,  700.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0, 3.0d0,  700.0000d0,    0.0d0,   0.0d0,
     7    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     ...
     2    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     7    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
...
c
     ...
     7    0.000000d0,  92.4d0,  139.5702d0,    0.0d0,   0.0d0/
c
c
      data topenn/
     6   -1.290000d0,  92.4d0,  134.9766d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.15050203d0,  2.0d0,  700.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   0.000000000d0,  2.0d0,  700.0000d0,    0.0d0,   0.0d0/
...
c
      data t1s0nn/
     7   -0.1509590d0,  2.0d0,  700.0000d0,    0.0d0,   0.0d0/
c
c
...
10008 format (1h ,48(1h-))
10009 format (2a4,a2,i3,2f10.2)
10010 format (1h ,2a4,a2,i3,2f10.2)
10011 format (//' n2lo500: Charge-Dependent Chiral NN Potential',
     1/' at Order Three using Lambda = 500 MeV, N2LO(500)')
...
c
      ...
      if (ityp.lt.1.or.ityp.gt.59) go to 9002
c
      im=ime
c
...
c
     ...
     5 5100,5200,5300,5400,5500,5600,5700,5800,25900),ityp 
c
c
c
c
